...
export const PromptInputActionAddAttachments = ({
  ...
  const handleSelect = useCallback(
    // Base UI passes a synthetic event here, not a DOM Event as Radix did
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    // Base UI button onClick expects its augmented event type
...
// Radix-era delay props; this Base UI PreviewCard Root has no delay API,
// so they are accepted for compatibility and intentionally dropped.
